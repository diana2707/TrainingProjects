...
namespace Cafe.Tests.InfrastructureTests.ObserversTests
{
    public class InMemoryOrderAnalyticsTests
    {
        ...
        public void GetTotalOrders_ShouldReturnCorrectCount_AfterMultipleOrderPlacedEvents()
        {
            ...
            OrderPlaced order1 = new("Espresso", PricingPolicyType.Regular, 2.50m, 2.50m);
            OrderPlaced order2 = new("Tea", PricingPolicyType.Regular, 2.00m, 2.00m);
            OrderPlaced order3 = new("Hot Chocolate", PricingPolicyType.Regular, 3.00m, 3.00m);
